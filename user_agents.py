...
class Get_Agent:
    def __init__(self):
        ...
        self.firefox_agents = ['Mozilla/5.0 (Windows NT 6.1; WOW64; rv:77.0) Gecko/20190101 Firefox/77.0',
    ...
    def firefox(self):
        random.shuffle(self.firefox_agents)

        random_index = random.randint(0, len(self.firefox_agents) - 1)

        return self.firefox_agents[random_index]

    def safari(self):
        random.shuffle(self.safari_agents)

        random_index = random.randint(0, len(self.safari_agents) - 1)

        return self.safari_agents[random_index]

    def chrome(self):
        random.shuffle(self.chrome_agents)

        random_index = random.randint(0, len(self.chrome_agents) - 1)

        return self.chrome_agents[random_index]

    def mixed_agent(self):
        mixed_agents = [self.firefox_agents, self.safari_agents, self.chrome_agents][0]

        random.shuffle(mixed_agents)

        random_Index = random.randint(0, len(mixed_agents) - 1)

        return mixed_agents[random_Index]
